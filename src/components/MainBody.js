      ...
      >
        ...
        >
          ...
          >
            ...
            >
              FIND MY BEER <span style={{paddingLeft:"10px"}}><img src="./Vector.png"/></span>
            </span>
          </div>
        </div>
        <div
        ...
        <div style={{textAlign:"center",width:"100%",paddingTop:"45px"}} >
          <a href="#footer" style={{textDecoration:"none",color:"white"}}>
            <span style={{textAlign:"center"}}><img src="./Arrow 5.png"/></span><br/>
            <span style={{}}>Scroll Down</span>
            </a>
        </div>
      </div>
      </div>
